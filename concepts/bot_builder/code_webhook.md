...
4. Open your `index.js` and copy and paste this snippet.
...
3. Open your `bot.rb` and copy and paste this snippet.
...
3. Open your `bot.py` and copy and paste this snippet.  
...
3. Copy and paste this snippet in the `index.php`  
